    ...
    >
      <div className="w-full max-w-md relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-white/80">Create your free account</p>
        </div>

        <GlassCard variant="dark" padding="none">
          <div className="p-8">
            {error ? <div role="alert" className="mb-6 rounded-md bg-red-500/10 border border-red-500/20 p-3 text-sm text-red-400">
                {error}
              </div> : null}
            ...
            <div className="relative mb-5">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-transparent px-2 text-white/40">or sign up with email</span>
              </div>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-white/60">
              ...
              <Link
                href={`/${locale}/auth/login${searchParams.get("callbackUrl") ? `?callbackUrl=${encodeURIComponent(searchParams.get("callbackUrl")!)}` : ""}`}
