...
/**
 * Memoized: each message bubble only re-renders when its own content changes.
 * Without memo, the entire list re-renders on every new message arrival or
 * streaming update to the latest assistant message.
 */
export const ChatMessage = memo(function ChatMessage({ message, onTimestampClick }: ChatMessageProps) {
  /**
