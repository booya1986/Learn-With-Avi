...
1. **[LearnWithAvi-PRD.md](../LearnWithAvi-PRD.md)** - Current PRD (v3.0)
2. **[LearnWithAvi-PRD-Complete-History.md](../LearnWithAvi-PRD-Complete-History.md)** - All PRD versions
3. **[SKILLS_RECOMMENDATIONS.md](SKILLS_RECOMMENDATIONS.md)** - Comprehensive skills analysis
4. **[SKILLS_SUMMARY.md](../SKILLS_SUMMARY.md)** - Skills implementation overview
